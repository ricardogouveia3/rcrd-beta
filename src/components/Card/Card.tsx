...
export default function Card({ children, classNames = '', contentClassnames = 'p-4 lg:p-6', loading = false }: Readonly<CardProps>) {
  ...
  return (
    <div className={`relative bg-white dark:bg-quartz-d60/75 flex h-full flex-col overflow-hidden border border-quartz-l80 hover:border-quartz-l70 dark:border-quartz-d10 dark:hover:border-quartz-d30  transition-all ease-in-out ${classNames}`}>
