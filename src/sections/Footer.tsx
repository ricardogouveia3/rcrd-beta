  ...
  return (
    <Card classNames={`${classNames}  rounded-lg text-sm text-black dark:text-white text-center`}>
      <p className="text-center font-semibold">
        {currentYear} - Ricardo Gouveia - <a href="https://creativecommons.org/licenses/by-sa/4.0/deed.pt_BR" target="_blank" className="underline">CC BY-SA 4.0</a><span className="text-xs text-quartz-9500 font-normal block mt-1">(unless otherwise specified and/or in content replicated from other sources | Logos and trademarks belong to their respective owners)</span>
      </p>
      <p className="italic text-xs text-quartz-600 dark:text-quartz-750 mt-3">
